...
# T1 实机返回的 v0.4 能力响应使用 codec=0x0002；该 codec 对应 16 kHz ADPCM。
# 0x0001 保留为协议中的 8 kHz ADPCM 标识，避免把 codec 值和采样率混淆。
ATVV_CODEC_ADPCM_8KHZ = 0x0001
ATVV_CODEC_ADPCM_16KHZ = 0x0002
ATVV_V04_FRAME_SIZE = 134
ATVV_V04_SAMPLE_RATE = 16_000
